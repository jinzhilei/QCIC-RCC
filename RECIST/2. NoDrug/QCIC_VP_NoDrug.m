function y = QCIC_VP_NoDrug(t,x,theta_TN4,theta_TN8,theta_D0,theta_M,beta_Th,beta_Tr,beta_Tc,G_X1,d_X1,beta_X1)
...
proliferation_X1_D = (beta_X1  )* (1 - (par.a11 * X1_D )/G_X1) * X1_D;
