function y = QCIC_VP(t,x,theta_TN4,theta_TN8,theta_D0,theta_M,kappa_Th,kappa_Tr,kappa_Tc,beta_Th,beta_Tr,beta_Tc,G_X1,beta_X1,d_X1)
...
immune_X1_D = (par. eta_Th * Th_D + par.eta_Tc * Tc_D) * ( 1  ) * (1/ (Tr_D/par.K_Tr  + 1)) * X1_D;
