function y = QCIC_VP_AB(t,x,theta_TN4, theta_TN8, theta_D0, theta_M, ...
...
proliferation_X1_D = (beta_X1 / (1 + Lambda_B * (B_B^par.n_B / (par.P^par.n_B+B_B^par.n_B) ) ) )* (1 - (par.a11 * X1_D + par.a12 * X2_D + par.a13 * X3_D + par.a14 * X4_D)/G_X1) * X1_D;
transformation_X2X1 = rho_X2X1 * ( A_B^par.n_3 / (par.K_A^par.n_3 + A_B^par.n_3) ) * X1_D;
transformation_X3X1 = rho_X3X1 * ( B_B^par.n_3 / (par.K_B^par.n_3 + B_B^par.n_3) ) * X1_D;
transformation_X4X1 = rho_X4X1 * ( A_B^par.n_3 / (par.K_A^par.n_3 + A_B^par.n_3) )*( B_B^par.n_3 / (par.K_B^par.n_3 + B_B^par.n_3) ) * X1_D;
apoptosis_X1_D = d_X1 * X1_D;
immune_X1_D = (par. eta_Th * Th_D + par.eta_Tc * Tc_D) * ( 1 + Lambda_A * (A_B^par.n_A / (par.Q^par.n_A+A_B^par.n_A) ) ) * (1/ (Tr_D/par.K_Tr + 1)) * X1_D;

% ====== ARTC ======
proliferation_X2_D = (beta_X2 / (1 + Lambda_B * (B_B^par.n_B / (par.P^par.n_B+B_B^par.n_B) ) ) ) * (1 - (par.a21 * X1_D + par.a22 * X2_D + par.a23 * X3_D +par.a24 * X4_D)/G_X2) * X2_D;
transformation_X4X2 = rho_X4X2 * ( B_B^par.n_4 / (par.K_B^par.n_4 + B_B^par.n_4) ) * X2_D;
apoptosis_X2_D = d_X2 * X2_D;
immune_X2_D = (par.eta_Th * Th_D + par.eta_Tc * Tc_D) * (  (1 / (Tr_D/par.K_Tr + 1))) * X2_D;

% ====== BRTC ======
proliferation_X3_D = beta_X3 * (1 - (par.a31 * X1_D + par.a32 * X2_D + par.a33 * X3_D + par.a34 * X4_D )/G_X3) * X3_D;
transformation_X4X3 = rho_X4X3 * ( A_B^par.n_3 / (par.K_A^par.n_3 + A_B^par.n_3) ) * X3_D;
apoptosis_X3_D = d_X3 * X3_D;
immune_X3_D = (par. eta_Th * Th_D + par.eta_Tc * Tc_D) *  ( 1 + Lambda_A * (A_B^par.n_A / (par.Q^par.n_A+A_B^par.n_A) ) ) * (1/ (Tr_D/par.K_Tr + 1)) * X3_D;

% ====== DRTC ======
proliferation_X4_D = beta_X4 * (1 - (par.a41 * X1_D + par.a42 * X2_D + par.a43 * X3_D + par.a44 * X4_D )/G_X4) * X4_D;
apoptosis_X4_D = d_X4 * X4_D;
...
y(31) = ( 1 / V_1_B ) * ( Q_B * ( B_D - B_B ) - CI_B * B_B - V_max_B * ( B_B / ( B_B + K_B_A ) ) );
y(32) = ( 1 / V_2_B ) * ( Q_B * ( B_B - B_D ));
