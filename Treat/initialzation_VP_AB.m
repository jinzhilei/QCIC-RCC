function y0=initialzation_VP_AB(i,Q_Ate,Q_Bte) 
...
cell = cell2mat(struct2cell(load(file_Tumor_0)));
...
par.Tc_D_0 = 5e7;      par.TAM_D_0 = 5e7;       par.X1_D_0 = cell(i);        par.X2_D_0 = 0;
par.X3_D_0 = 0;        par.X4_D_0 = 0;          par.A_B = Q_Ate;      par.A_D = 0;
par.B_B = Q_Bte;      par.B_D = 0;
...
y0 = [par.D0_A_0;par.D0_B_0;par.D0_D_0;par.D_C_0;par.D_D_0;par.D_E_0;...
    ...
    par.X1_D_0;par.X2_D_0;par.X3_D_0;par.X4_D_0;par.A_B;par.A_D;par.B_B;par.B_D];
