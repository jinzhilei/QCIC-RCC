...
proliferation_X1_D = (par.beta_X1 / (1 + par.Lambda_B * par.B_D)) * (1 - (par.a11 * X1_D + par.a12 * X2_D + par.a13 * X3_D + par.a14 * X4_D)/par.G_X1) * X1_D;
...
immune_X1_D = (par. eta_Th * Th_D + par.eta_Tc * Tc_D) * ( 1 + par.Lambda_A * par.A_D) * (1/ (par.K_Tr/Tr_D + 1)) * X1_D;

% ====== ARTC ======
proliferation_X2_D = (par.beta_X2 / (1 + par.Lambda_B * par.B_D)) * (1 - (par.a21 * X1_D + par.a22 * X2_D + par.a23 * X3_D +par.a24 * X4_D)/par.G_X2) * X2_D;
transformation_X4X2 = par.rho_X4X2 * ( par.B_D^par.n_4 / (par.K_B^par.n_4 + par.B_D^par.n_4) ) * X2_D;
apoptosis_X2_D = par.d_X2 * X2_D;
immune_X2_D = (par.eta_Th * Th_D + par.eta_Tc * Tc_D) * (  (1 / (par.K_Tr/Tr_D + 1))) * X2_D;

% ====== BRTC ======
proliferation_X3_D = par.beta_X3 * (1 - (par.a31 * X1_D + par.a32 * X2_D + par.a33 * X3_D + par.a34 * X4_D )/par.G_X2) * X2_D;
transformation_X4X3 = par.rho_X4X3 * ( par.A_D^par.n_3 / (par.K_A^par.n_3 + par.A_D^par.n_3) ) * X3_D;
apoptosis_X3_D = par.d_X3 * X3_D;
immune_X3_D = (par. eta_Th * Th_D + par.eta_Tc * Tc_D) * ( 1 + par.Lambda_A * par.A_D) * (1/ (par.K_Tr/Tr_D + 1)) * X3_D;

% ====== DRTC ======
proliferation_X4_D = par.beta_X4 * (1 - (par.a41 * X1_D + par.a42 * X2_D + par.a43 * X3_D + par.a44 * X4_D )/par.G_X3) * X3_D;
apoptosis_X4_D = par.d_X4 * X4_D;
immune_X4_D = (par.eta_Th * Th_D + par.eta_Tc * Tc_D) * (  (1 / (par.K_Tr/Tr_D + 1))) * X4_D;
