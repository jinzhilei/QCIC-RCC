...
function y = QCIC_VP_AB(t,x,V_1_A,V_2_A,Q_A,CI_A,V_max_A,K_A_A,V_1_B,V_2_B,Q_B,CI_B,V_max_B,K_B_A,...
...
transformation_X2X1 = rho_X2X1 * ( A_B^par.n_3 / (K_A^par.n_3 + A_B^par.n_3) ) * X1_D;
transformation_X3X1 = rho_X3X1 * ( B_B^par.n_3 / (K_B^par.n_3 + B_B^par.n_3) ) * X1_D;
transformation_X4X1 = rho_X4X1 * ( A_B^par.n_3 / (K_A^par.n_3 + A_B^par.n_3) )*( B_B^par.n_3 / (K_B^par.n_3 + B_B^par.n_3) ) * X1_D;
...
transformation_X4X2 = rho_X4X2 * ( B_B^par.n_4 / (K_B^par.n_4 + B_B^par.n_4) ) * X2_D;
...
transformation_X4X3 = rho_X4X3 * ( A_B^par.n_3 / (K_A^par.n_3 + A_B^par.n_3) ) * X3_D;
