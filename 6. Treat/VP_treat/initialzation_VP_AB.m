function y0=initialzation_VP_AB(Q_Ate,Q_Bev,r) 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Variable initial value (cell)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

file='./VP_patient/VPsample_immune.mat';
...
par.X3_D_0 = 0;              par.X4_D_0 = 0;               par.A_B = Q_Ate(1);      par.A_D = Q_Ate(2);
par.B_B = Q_Bev(1);      par.B_D = Q_Bev(2);
