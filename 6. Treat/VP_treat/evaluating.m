...
% file_R=['./VP_AB/VP_tumor_number',num2str(2),'.mat'];
...
for i =1:sample
    ...
    file=['./treat_AB/Adaptive_therapy/','VPsample_AB',num2str(i),'.mat'];
    cell=cell2mat(struct2cell(load(file)));
    % file=strcat('treat_AB/treat',num2str(2),'/VPsample_AB',num2str(i),'.mat');
    % cell=cell2mat(struct2cell(load(file)));
